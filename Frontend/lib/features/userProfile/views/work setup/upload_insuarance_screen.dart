...
class UploadInsuranceScreen extends GetView<WorkSetupController> {
  const UploadInsuranceScreen({super.key});
          ...
          children: [
                  ...
                  decoration: BoxDecoration(
                    ...
                    image:
                        controller.insuranceImg.value != null
                            ? DecorationImage(
                              image: FileImage(
                                File(controller.insuranceImg.value!.path),
                              ),
                              fit: BoxFit.cover,
                            )
                            : null,
            ...
            Center(
              child: GestureDetector(
                onTap: () => controller.pickImg(context, controller.insuranceImg),
                child: Container(
                  width: 70.w,
                  height: 70.h,
                  decoration: BoxDecoration(
            ...
            CustomButton(text: 'Continue',
             onPressed: (){
              controller.selectedWorkTiming.value='';
                Get.toNamed('/workTiming');
             },
             isEnabled: controller.insuranceImg.value != null,))
          ],
        ),
      ),
    );
